...
$(document).on("click", ".edit-btn", function () {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#editInventoryId").val(InventoryResults.inventory_id);
            ...
            $("#editStatus").val(InventoryResults.status);
